...
@Config
@Autonomous
public class FinalsAutoRedNew extends LinearOpMode {
    Robot robot;
    Functions functions;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        goToPowershots = robot.drive.trajectoryBuilder(startPose)
                .splineTo(new Vector2d(-12, -16), Math.toRadians(-12.5))
                .build();

        goToBounceBacks = robot.drive.trajectoryBuilder(new Pose2d(-12, -16 ,0))
                .lineTo(new Vector2d(49, -12))
                .build();

        goToB = robot.drive.trajectoryBuilder(goToBounceBacks.end())
        ...
        goToShootA = robot.drive.trajectoryBuilder(new Pose2d(32, -16, 0))
                .lineTo(new Vector2d(5, -16))
                .build();
...
//        sidehood.setPosition(angle3);
        ...
        kick();
        kick();
        robot.drive.turn(Math.toRadians(12.5+6+6));
        Shooter.rpm = 0;
